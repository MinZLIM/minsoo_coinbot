    ...
    while True:
        try:
            ...
            for symbol in top_coins:
                try:
                    data = ccxt_function.fetch_data(f"{symbol}", exchange)
                    ...
                    target_price, stop_loss = ccxt_function.update_target_price(last_row['close'], last_row['upper_band'], last_row['lower_band'], market_flow)
